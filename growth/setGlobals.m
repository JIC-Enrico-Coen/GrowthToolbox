...
% 4: Whether it applies to volumetric meshes, foliate meshes, or both.
    gFIELDTYPES = {
        ...
        'mgenVertexColoring', { 'mgen' }, '', '';
        'fixedDFmap', { 'prismvx', 'dim' }, '', '';
        'globalDynamicProps.stitchDFsets', { 'prismvx', 'dim' }, '', '';
...
%             'selection', ...
    ...
    gPlotPriorities = { 'pervertex', 'perelement', 'percorner', 'tensor', 'morphogen', 'outputquantity', 'blank' };
