...
%   movies.
%
%   The options are as for addFadeInOut, omitting 'includefirst' and
%   'includelast', and adding these:
%
...
%
%   'abut'  If true, all of the options defining times of fades and pauses
%           default to zero, which causes the movies to be simply
%           concatenated. The default is false, in which case the default
%           values for all of the fade and pause times are various positive
%           values.
%
...
%   See also: addFadeInOut
    ...
    ok = checkcommandargs( mfilename(), s, 'exact', ...
        'dir', 'fps', 'abut', 'startcolor', 'endcolor', 'fadecolor', ...
        'fadein', 'fadeout', 'startpause', 'firstpause', 'lastpause', 'endpause', ...
        'gap', 'startgap', 'endgap' );
    if ~ok, return; end
