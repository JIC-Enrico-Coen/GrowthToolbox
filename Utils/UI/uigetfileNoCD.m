function [filename, pathname, filterindex] = uigetfileNoCD( directory, varargin )
%[filename, pathname, filterindex] = uigetfileNoCD( directory, varargin )
%   This is identical to the Matlab function uigetfile, except that it
...
%
%   See also: uigetfile, uiputfileNoCD.
